...
const featureWorksData = [
  {
    heading: "Transhumans Head Developer (Not Yet Released)",
    type: "Dashboard",
    img:
    ...
    text: "Developed a generative NFT Series that evolves through time. Users are able to stake their NFT on the blockchain to earn EXP. The collection also offers an off-chain taken called $ARC which users can earn by being active as well as participating in giveaways. I've created a web-app for admins and moderators to be able to reward certain addresses $ARC. Users will then be able to sign into our main website using their wallets and see how much $ARC they've accumulated. Users can use their $ARC to unlock season passes, buy whitelist passes, and many other functionalities.",
    topics: ['Conditional NFT Image Generation',"NFT's that Evolve Over Time","Smart Contract Development","Merkle Root Whitelist","Reveal","Web3 Interface","Rarity "]
    },
  {
    heading: "Splash x Bored Puma Head Developer",
    type: "Illustration",
    img:
  ...
  {
    heading: "Sleepy Sloth Society Co-Founder / Head-Developer",
    type: "Typography",
    img:
  ...
  return (
    ...
    >
      ...
      {featureWorksData.map((work) => (
        ...
        >
            <WorksCard topics = {work.topics} text ={work.text} heading={work.heading} img={work.img} type={work.type} />
